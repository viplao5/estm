<template>
  <el-drawer v-model="dialogVisible" title="产品与服务详情" size="1200px">
    <div v-loading="loading" class="p-20px">
      ...
      <el-descriptions :column="2" border title="基本信息" class="mb-20px">
        ...
        <el-descriptions-item label="销售收入(万)">{{ detailData.revenue }}</el-descriptions-item>
        <el-descriptions-item label="销售毛利(万)">{{ detailData.profit }}</el-descriptions-item>
        <el-descriptions-item label="重要客户" :span="2">{{ detailData.keyCustomers }}</el-descriptions-item>
